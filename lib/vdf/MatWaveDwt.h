...
//! Sam: timers to keep track of time elapsed in forward_xform and inverse_xform
struct timeval _fxformTimer, _ixformTimer;
void ResetFXformTimer();
void ResetIXformTimer();
struct timeval GetFXformTimer();
struct timeval GetIXformTimer();
void AddFXformTime( struct timeval &start, struct timeval &end );
void AddIXformTime( struct timeval &start, struct timeval &end );
//! Sam: timers to keep track of time elapsed in forward_xform and inverse_xform
void TestCuda();
