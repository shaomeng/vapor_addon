...
cube3d.o: cube3d.cpp cube3d.h
	g++ -o bin/cube3d.o -c -std=c++0x -DLINUX -Wall -Wno-sign-compare  -D__USE_LARGEFILE64 -pthread -fPIC -m64 -g -I/home/samuel/Tools/vapor-git/install/include -I. -DMODELS cube3d.cpp

slicegroup.o: bin/cube3d.o slicegroup.cpp slicegroup.h
	g++ -o bin/slicegroup.o -c -std=c++0x -DLINUX -Wall -Wno-sign-compare  -D__USE_LARGEFILE64 -pthread -fPIC -m64 -g -I/home/samuel/Tools/vapor-git/install/include -I. -DMODELS slicegroup.cpp
